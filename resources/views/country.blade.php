...
@section('content')
    ...
    <div class="w3_content_agilleinfo_inner">
        <div class="agile_featured_movies">
            ...
            <h3 class="agile_w3_title">{{ $country->name }} <span>Movies</span>
                <form action="" style="float: revert;
                max-width: 250px;
                margin-top: 25px;" >
                <input name="Search2" class="form-control form-country" type="search" placeholder="Search by country" style="margin-top: 5px;">
                <input type="hidden" id="selector-country" name="selector-country" value="{{$country->id}}">
            </form>
            </h3>
            <!--/requested-movies-->
                            ...
                            <div class="item">
                                <div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
                                    <a href="{{ route('movie.show', ['id' => $item->id]) }}"
                                        class="hvr-sweep-to-bottom"><img src="{{ $item->poster_path }}" title="Movies Pro"
